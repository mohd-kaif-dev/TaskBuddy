...
const Dashboard = () => {
  ...
  const checkResets = () => {
    ...
    if (lastLoginDate !== today) {
      ...
      // The issue may be with state updates not being immediate
      ...
      setGameState((prevState) => {
        const updated = {
          ...
          // Archive yesterday's achievements before resetting
          dailyAchievementHistory: {
          ...
          // Reset only daily badge progress while preserving permanent badge progress
          badgeProgress: {
            ...
            task_sprinter: 0,
            last_minute_hero: 0,
            // Preserve permanent badge progress
            streak_master: prevState.badgeProgress.streak_master,
            milestone_hunter: prevState.badgeProgress.milestone_hunter,
            perfectionist: prevState.badgeProgress.perfectionist,
            priority_master: prevState.badgeProgress.priority_master,
            team_player: prevState.badgeProgress.team_player,
            consistency_king: prevState.badgeProgress.consistency_king,
          },
  ...
  useEffect(() => {
    checkResets();
    const interval = setInterval(checkResets, 3600000); // Check every hour
